...
(function () {
  ...
  const FALLBACK_MODULES = [
    ...
    { MODULE_ID:'MOD-008', APP_GROUP:'INVENTORY', MODULE_KEY:'RIWAYAT_TRANSAKSI', MODULE_NAME:'Riwayat Inventory', PARENT_MENU:'Inventory', URL:'riwayat-inventory.html', PERMISSION_KEY:'riwayatTransaksi', MENU_ORDER:70, IS_MENU:'Y', STATUS:'AKTIF', ICON:'history' },
